...
Программирую на **Java**, **Python** и **C++**, побывал на конференциях **SberCommunityDay** и **Стачка-2025**, вёл проект по криптографии, пробовал себя в создании сайтов.
...
- **Области:** Алгоритмы и структуры данных, криптография, AI-prompting
